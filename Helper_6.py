...
class Schedule:
    ...
    def create_df(self):
        """Извлекаем данные из занятий датафрейм и экспортируем его в Excel таблицу """
        ...
        # excel_export(self.schedule_df, 'scheduler.xlsx', 'sheet_1')  # Экспортируем датафрейм в scheduler.xlsx
        excel_export(self.schedule_df, self.file_path, 'sheet_1')  # Экспортируем датафрейм в scheduler.xlsx
